...
var (
	...
	adjustWindowForDPI   = user32.NewProc("AdjustWindowRectExForDpi")
	...
	setBGColor           = gdi32.NewProc("SetBkColor")
	setBGMode            = gdi32.NewProc("SetBkMode")
	roundRect            = gdi32.NewProc("RoundRect")
	lineMove             = gdi32.NewProc("MoveToEx")
	lineTo               = gdi32.NewProc("LineTo")
	setWindowTheme       = syscall.NewLazyDLL("uxtheme.dll").NewProc("SetWindowTheme")
